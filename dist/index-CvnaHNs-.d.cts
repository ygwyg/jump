...
type JumpTarget = Element | Element[] | NodeList | string | Ref<Element | null>;
...
type JumpFunction = {
    (target: JumpTarget, animation: AnimationDefinition, options?: JumpOptions): JumpControls;
    /**
     ...
     * ```
     */
    to: (target: JumpTarget, properties: AnimatableProperties, options?: JumpOptions) => JumpControls;
    /**
     ...
     * ```
     */
    from: (target: JumpTarget, properties: AnimatableProperties, options?: JumpOptions) => JumpControls;
    /**
     ...
     * ```
     */
    shared: (target: Element, id: string, options?: LayoutOptions) => Animation | null;
    /**
     ...
     * ```
     */
    flip: (target: Element, from: LayoutSnapshot, options?: LayoutOptions) => Animation | null;
    /**
     ...
     * ```
     */
    hover: (target: JumpTarget, options: {
     ...
     * ```
     */
    press: (target: JumpTarget, options: {
     ...
     * ```
     */
    scroll: (target: JumpTarget, animation: AnimationDefinition, options?: JumpOptions & {
     ...
     * ```
     */
    drag: (target: JumpTarget, options?: {
        axis?: "x" | "y" | "both";
        bounds?: {
            top?: number;
            right?: number;
     ...
     * ```
     */
    text: (target: JumpTarget, mode: "reveal by word" | "reveal by char" | "reveal by line" | "typewriter" | "scramble", options?: JumpOptions & {
     ...
     * ```
     */
    animate: (source: Record<string, number>, target: Record<string, number>, options?: JumpOptions & {
     ...
     * ```
     */
    scrollProgress: (element?: Element, options?: {
        axis?: "x" | "y";
        container?: Element | Window;
    }) => {
        get: () => number;
    ...
    parallel: (steps: SequenceStep[], options?: Pick<SequenceOptions, "onComplete">) => JumpControls;
};

export type { AnimatableProperties as A, CSSAnimationProperties as C, Easing as E, FadeIntent as F, JumpOptions as J, LayoutOptions as L, ScaleIntent as S, TransformProperties as T, LayoutSnapshot as a, AnimationDefinition as b, AnimationDirection as c, AnimationIntent as d, EasingPreset as e, EmphasisIntent as f, EnterIntent as g, ExitIntent as h, FillMode as i, FlipIntent as j, JumpControls as k, JumpFunction as l, JumpKeyframe as m, JumpTarget as n, LayoutStyle as o, SequenceOptions as p, SequenceStep as q, SlideIntent as r };
